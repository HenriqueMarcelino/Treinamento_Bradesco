...
create procedure gravar(in vnome  varchar(80) ,in vemail varchar(80),in  vuuid   varchar(50),in vsenha  varchar(255),in  vdataCadastro  date)
 begin
	  ...
	  insert  into usuario (nome, email, uuid, senha, datacadastro)  
              values (vnome, vemail, vuuid, vsenha, vdataCadastro);
...
call gravar('henrique', 'henrique@gmail.com', '12121211212', '123456', now());
